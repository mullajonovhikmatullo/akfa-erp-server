...
exports.AdminsController = {
    async create(req, res, next) {
        try {
            const admin = await admins_service_1.AdminsService.create(req.body);
    ...
    async findAll(req, res, next) {
        try {
            ...
            if (req.query.page !== undefined) {
                ...
                const result = await admins_service_1.AdminsService.findPaginated({ ...filters, page, pageSize });
                return ApiResponse_1.ApiResponse.success(res, result);
            }
            const admins = await admins_service_1.AdminsService.findAll(filters);
    ...
    async findById(req, res, next) {
        try {
            const admin = await admins_service_1.AdminsService.findById(req.params.id);
    ...
    async update(req, res, next) {
        try {
            const admin = await admins_service_1.AdminsService.update(req.params.id, req.body);
    ...
    async disable(req, res, next) {
        try {
            const admin = await admins_service_1.AdminsService.disable(req.params.id);
    ...
    async enable(req, res, next) {
        try {
            const admin = await admins_service_1.AdminsService.enable(req.params.id);
    ...
    async delete(req, res, next) {
        try {
            await admins_service_1.AdminsService.delete(req.params.id);
